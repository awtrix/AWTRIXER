(function () {
  ...
  ns.SaveController.prototype.init = function () {
    ...
    this.uploadButton = document.querySelector('.c-download-button');

    this.safeAddEventListener_(this.uploadButton, 'click', this.onUploadClick);
  ...
  ns.SaveController.prototype.getDescriptor_ = function () {
    ...
    return new pskl.model.piskel.Descriptor(name, this.isPublic_());
  };
  ...
  ns.SaveController.prototype.onUploadClick = function () {
    ...
    awtrix_raiseEvent("new_icon", { "name": cName, "data": icon, "tick": tickrate, "width": width, "height": height });
  };

  ns.SaveController.prototype.rgbTo565 = function (r, g, b) {
    var B = (b >> 3) & 0x1f;
    var G = ((g >> 2) & 0x3f) << 5;
    var R = ((r >> 3) & 0x1f) << 11;
    var rgb = (R | G | B);
